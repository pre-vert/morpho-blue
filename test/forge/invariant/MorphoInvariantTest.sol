...
contract MorphoInvariantTest is InvariantTest {
    ...
    function _supplyAssets(MarketParams memory _marketParams, uint256 assets) internal logCall("supplyAssets") {
        loanToken.setBalance(msg.sender, assets);

        vm.prank(msg.sender);
        morpho.supply(_marketParams, assets, 0);
    }

    function _supplyShares(MarketParams memory _marketParams, uint256 shares) internal logCall("supplyShares") {
        ...
        vm.prank(msg.sender);
        morpho.supply(_marketParams, 0, shares);
    }

    function _withdraw(MarketParams memory _marketParams, uint256 assets, uint256 shares) internal {
        vm.prank(msg.sender);
        morpho.withdraw(_marketParams, assets, shares);
    }

    function _borrow(MarketParams memory _marketParams, uint256 assets, uint256 shares) internal {
        vm.prank(msg.sender);
        morpho.borrow(_marketParams, assets, shares);
    }

    function _repayAssets(MarketParams memory _marketParams, uint256 assets) internal logCall("repayAssets") {
        loanToken.setBalance(msg.sender, assets);

        vm.prank(msg.sender);
        morpho.repay(_marketParams, assets, 0);
    }

    function _repayShares(MarketParams memory _marketParams, uint256 shares) internal logCall("repayShares") {
        ...
        vm.prank(msg.sender);
        morpho.repay(_marketParams, 0, shares);
    }

    function _supplyCollateral(MarketParams memory _marketParams, uint256 assets)
        internal
        logCall("supplyCollateral")
    {
        ...
        vm.prank(msg.sender);
        morpho.supplyCollateral(_marketParams, assets);
    }

    function _withdrawCollateral(MarketParams memory _marketParams, uint256 assets)
        internal
        logCall("withdrawCollateral")
    {
        vm.prank(msg.sender);
        morpho.withdrawCollateral(_marketParams, assets);
    }
        ...
        logCall("liquidateSeizedAssets")
    {
        ...
        vm.prank(msg.sender);
        morpho.liquidate(_marketParams, borrower, seizedAssets, 0);
    }
        ...
        logCall("liquidateRepaidShares")
    {
        ...
        vm.prank(msg.sender);
        morpho.liquidate(_marketParams, borrower, 0, repaidShares);
    }
    ...
    //     _supplyAssets(_marketParams, assets);
    // }
    ...
    //     _supplyShares(_marketParams, shares);
    // }

    // function withdrawAssetsOnBehalfNoRevert(uint256 marketSeed, uint256 assets, uint256 onBehalfSeed)
    //     external
    // {
    ...
    //     _withdraw(_marketParams, assets, 0);
    // }

    // function borrowAssetsOnBehalfNoRevert(uint256 marketSeed, uint256 assets, uint256 onBehalfSeed)
    //     external
    // {
    //     // vm.assume(receiver != address(0));
    ...
    //     assets = _boundBorrowAssets(_marketParams, assets);
    //     if (assets == 0) return;

    //     _borrow(_marketParams, assets, 0);
    // }
    ...
    //     assets = _boundRepayAssets(_marketParams, assets);
    //     if (assets == 0) return;

    //     _repayAssets(_marketParams, assets);
    // }
    ...
    //     shares = _boundRepayShares(_marketParams, shares);
    //     if (shares == 0) return;
